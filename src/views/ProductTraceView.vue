...
const modules = ref([
  {
    ...
    icon: '🌱',
    title: '种植溯源',
    path: '/product-trace/planting',
    description: '农产品种植全过程追溯'
  },
  {
    id: 2,
    icon: '⚙️',
    title: '加工溯源',
    path: '/product-trace/processing',
    description: '农产品加工环节追溯'
  },
  {
    id: 3,
    icon: '🚛',
    title: '物流溯源',
    path: '/product-trace/logistics',
    description: '产品物流配送追溯'
  },
  {
    id: 4,
    icon: '📜',
    title: '认证溯源',
    path: '/product-trace/certification',
    description: '质量认证与检测追溯'
  }
])
...
const showModules = computed(() => route.path === '/product-trace')
</script>
