...
const modules = ref([
  {
    ...
    icon: '📈',
    title: '农业发展',
    path: '/science/development',
    description: '农业发展趋势与前沿动态'
  },
  {
    id: 2,
    icon: '🏗️',
    title: '温室发展',
    path: '/science/greenhouse',
    description: '现代温室技术与发展历程'
  },
  {
    id: 3,
    icon: '📚',
    title: '农业知识',
    path: '/science/knowledge',
    description: '农业科技知识库'
  },
  {
    id: 4,
    icon: '🎭',
    title: '农业文化',
    path: '/science/culture',
    description: '传统农耕文化与现代农业'
  },
  {
    id: 5,
    icon: '🚜',
    title: '农业机械',
    path: '/science/machinery',
    description: '现代农业机械设备介绍'
  },
  {
    id: 6,
    icon: '🌾',
...
const showModules = computed(() => route.path === '/science')
</script>
  ...
  <div class="science">
    <!-- <div class="module-header">
      <div class="header-content">
        <h2>科普栏目</h2>
        <p class="description">农业科技知识传播与分享平台</p>
      </div>
    </div> -->
