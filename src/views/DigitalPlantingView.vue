...
const modules = ref([
  {
    ...
    icon: '🌱',
    title: '数字化种植',
    path: '/digital-planting/planting',
    description: '智能化种植管理系统'
  },
  {
    id: 2,
    icon: '📋',
    title: '标准化生产',
    path: '/digital-planting/standard',
    description: '农业生产标准化体系'
  },
  {
    id: 3,
    icon: '💧',
    title: '水肥智能化',
    path: '/digital-planting/irrigation',
    description: '智能水肥一体化系统'
  }
])
...
// 判断是否显示模块选择界面
const showModules = computed(() => route.path === '/digital-planting')
</script>

<template>
  <div class="digital-planting">
