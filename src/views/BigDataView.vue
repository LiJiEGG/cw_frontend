...
const modules = ref([
  {
    ...
    icon: '📥',
    title: '数据采集',
    path: '/big-data/collection',
    description: '多源数据采集与整合'
  },
  {
    id: 2,
    icon: '📊',
    ...
    description: '数据挖掘与智能分析'
  },
  {
    id: 3,
    icon: '🔄',
    title: '数据服务',
    path: '/big-data/service',
    description: '数据共享与服务支持'
  }
])
...
// 判断是否显示模块选择界面
const showModules = computed(() => route.path === '/big-data')
</script>
