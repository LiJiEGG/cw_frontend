...
const modules = ref([
  {
    ...
    icon: '📋',
    title: '定义与目标',
    path: '/smart-farm/definition',
    description: '智慧农场的概念与发展目标'
  },
  {
    id: 2,
    icon: '🏗️',
    title: '总体架构设计',
    path: '/smart-farm/architecture',
    description: '系统整体架构规划'
  },
  {
    id: 3,
    icon: '📝',
    title: '技术方案',
    path: '/smart-farm/technical',
    description: '具体技术实现方案'
  },
  {
    id: 4,
    icon: '🔍',
    title: '感知与控制',
    path: '/smart-farm/sensor',
    description: '环境监测与智能控制'
  },
  {
    id: 5,
    icon: '📊',
    title: '数据处理与分析',
    path: '/smart-farm/data',
    description: '农业大数据分析'
  },
  {
    id: 6,
...
// 判断是否显示模块选择界面
const showModules = computed(() => route.path === '/smart-farm')
</script>
